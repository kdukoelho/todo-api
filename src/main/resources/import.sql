...
INSERT INTO tb_task(id, name, description) VALUES("1", "Take garbage out", "");
INSERT INTO tb_task(id, name, description) VALUES("2", "Clean house", "We need to clean the rooms and the kitchen");
INSERT INTO tb_task(id, name, description) VALUES("3", "Finish biology exercise", "Ecologic relationships");
