...
public interface TaskRepository extends JpaRepository<Task, String> {
    ...
    @Query(value = "SELECT id, name, description, state FROM tb_task, user_has_task WHERE tb_task.id = user_has_task.task_id AND user_has_task.user_id =  :user_id", nativeQuery = true)
